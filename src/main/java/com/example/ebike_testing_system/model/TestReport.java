...
public TestReport(){}
    ...
    public TestReport(UUID uuid, LocalDateTime timestamp, double batteryVoltage, int batteryCurrent, double batteryCapacity, double batteryTemperatureCelsius,
                      int chargeStatus, int assistanceLevel, double torqueCrankNm, double bikeWheelSpeedKmh, int cadanceRpm, int engineRpm,
                      double enginePowerWatt, double wheelPowerWatt, double rollTorque, double loadcellN, double rolHz, double horizontalInclination,
                      double verticalInclination, int loadPower, boolean statusPlug) {
        this.uuid = uuid;
